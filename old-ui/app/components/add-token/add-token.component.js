      ...
      h('.flex-space-around', {
        style: {
         boxSizing: 'border-box',
             color: 'black',
             boxShadow: 'rgba(90, 0, 251, 0.3) 0px 8px 16px 0px',
             margin: '0px 4px 12px',
             padding: '20px',
             borderRadius: '10px',
             height: '510px' ,
        ...
        h('div', {
          ...
          h('button', { style:{ background: '#fb724c', marginRight: '10px', marginLeft: '-6px', width: '90px', marginTop: '-40px' }, 
